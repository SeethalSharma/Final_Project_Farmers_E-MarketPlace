...
function Header(){
    ...
    return (
        <div className="jumbotron p-2 mb-0 rounded-0 bg-transparent text-danger">
          ...
          <div  className="col-2"> <img src={'Logo.jpg'} style={{width:"150px"}} className="float-left"/></div> 
          <div  className="col-8"><h1 className="heading text-center font-weight-bold mt-3"> Welcome to Farmers E-MarketPlace </h1></div>
